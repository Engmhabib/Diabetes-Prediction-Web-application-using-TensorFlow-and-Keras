...
# Global constants for normalization (these values should be set based on your training data)
MIN_AGE = 1
MAX_AGE = 100
MIN_BMI = 10
MAX_BMI = 50
...
def load_model(model_path):
    try:
        ...
        st.error(f"Model file not found at path: {model_path}. Please check the file path.")
        return None
